...
public class ConsoleView {
    ...
    public void start() {
        while (true) {
            ...
            System.out.println(vm.isWin() ? "Congratulations, you have won the game!" : "Oh no, you detonated a mine! Game over.");
            printBoard(true);

            System.out.print("Press any to play again or 'q' to quit: ");
